...
import { BiHomeAlt, BiInfoCircle, BiCommentDetail, BiEnvelope, BiUserPlus, BiUser, BiMailSend, BiLock } from 'react-icons/bi';
      ...
      <main className="flex-grow flex justify-center items-center py-12 px-6">
        <div className="bg-white shadow-2xl rounded-3xl p-8 w-full max-w-md">
          <h2 className="text-3xl font-bold mb-6 text-center text-blue-600 flex items-center justify-center">
            <BiUserPlus className="mr-2 text-4xl" /> Register
          </h2>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              <BiUser className="absolute top-1/2 transform -translate-y-1/2 left-3 text-blue-500 text-xl" />
              <input
                type="text"
                value={name}
            ...
            >
              <BiUserPlus className="mr-2 text-xl" /> Register
            </button>
          </form>
          <div className="mt-6 text-center">
            <p className="text-gray-600">Already have an account?</p>
            <Link to="/login" className="text-blue-500 hover:text-blue-600 font-medium transition-colors duration-300">
              Login here
            </Link>
          </div>
        </div>
